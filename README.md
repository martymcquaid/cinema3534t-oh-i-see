...
- **Dev Server URL**: `http://127.0.0.1:5249`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/c6a52936-cf5c-473a-9d0e-456934ef2d79/preview`
- **Port**: `5249`
...
4. The dev server is accessible at `http://127.0.0.1:5249`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/c6a52936-cf5c-473a-9d0e-456934ef2d79/preview`
